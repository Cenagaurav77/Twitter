...
const THome = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      //   `${process.env.REACT_APP_BE_NETWORK}:${process.env.REACT_APP_BE_PORT}/tweets-results`
      // );
      // const res = await fetch(
      //   `${process.env.REACT_APP_API_SERVICE_URL}:${process.env.NODE_ENV}/tweets-results`
      // );
